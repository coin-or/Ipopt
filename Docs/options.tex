...
scaling is independent of the NLP problem
scaling.  This option is only available if Ipopt
...
\paragraph{pardiso\_out\_of\_core\_power:} Enables out-f-core variant of Pardiso $\;$ \\
