...
#define IPOPTLINEARSOLVER_PARDISO 0x020u
#define IPOPTLINEARSOLVER_SPRAL   0x040u
#define IPOPTLINEARSOLVER_WSMP    0x080u
#define IPOPTLINEARSOLVER_MUMPS   0x100u
...
/** get bitflags indicating which linear solvers are available to Ipopt
 *
