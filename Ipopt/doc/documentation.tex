...
\item If you want to compile \Ipopt with the linear solver Pardiso
  ...
  \begin{verbatim}
  MKL_LIBS="-L${MKLROOT}/lib/intel64 -Wl,--no-as-needed -lmkl_intel_lp64
    -lmkl_lapack95_lp64 -lmkl_sequential -lmkl_core -lgfortran -fopenmp -lpthread -lm -ldl"
  ADD_CFLAGS="-fopenmp -fno-common -fexceptions"
  ADD_CXXFLAGS="-fopenmp -fno-common -fexceptions"
  ADD_FFLAGS="-fopenmp -fexceptions"
  ./configure -C F77=gfortran CC=gcc CXX=g++
    --with-blas-lib="${MKL_LIBS}" --with-lapack-lib="${MKL_LIBS}"
    --with-pardiso="libpardiso600-GNU720-X86-64.so -lgfortran -lquadmath"
  \end{verbatim}
