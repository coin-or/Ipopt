...
previous section, it should be sufficient to create a folder {\tt \$IPOPTDIR/build/share}, copy the site file to that folder, and rename it to {\tt config.site} before running configure.
Alternatively, you can setup an environment variable 
{\tt CONFIG\_SITE} that points to the site file
{\tt \$IPOPTDIR/contrib/MatlabInterface/MatlabInterface.site}.
