...
\begin{abstract}
  This document is a guide to using \Ipopt\ 3.4.1.  It includes
...
{\tt \$ svn co https://projects.coin-or.org/svn/Ipopt/stable/3.4 CoinIpopt} \\
...
\item Download the desired tarball from
  ...
  number, such as {\tt 3.4.1}.  There might also be daily snapshot
