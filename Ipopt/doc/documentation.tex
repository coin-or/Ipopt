%% Copyright (C) 2005, 2009 Carnegie Mellon University and others.
%%
...
\begin{abstract}
  This document is a guide to using \Ipopt\ 3.8.0.  It includes
...
\item Download the desired tarball from
  ...
  number, such as {\tt 3.8.0}.  There might also be daily snapshot
