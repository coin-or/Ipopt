%% Copyright (C) 2005, 2010 Carnegie Mellon University and others.
%%
...
\begin{abstract}
  This document is a guide to using \Ipopt\ 3.9.1.  It includes
...
\item Download the desired tarball from
  ...
  number, such as {\tt 3.9.1}.  There might also be daily snapshot
