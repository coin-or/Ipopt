...
\item A sparse symmetric indefinite linear solver. \Ipopt\ needs
  ...
  The \Ipopt\ library also has mechanisms to load the MA27, MA57, HSL\_MA86, and
  ...
  If you are compiling MA57, HSL\_MA86, or MUMPS within the \Ipopt\ build
...
licence from the authors. This version includes both MA27 and MC19.
\item[HSL 2011] contains more modern codes that are freely available for
academic use only. This version includes the codes from the HSL Archive and additionally MA57, HSL\_MA77, and HSL\_MA86.
\end{description}
...
You can obtain a free evaluation license of Pardiso for
``internal evaluation, examination and testing purposes''
(taken from the license agreement) or buy an academic or commercial
...
including a trial license key for a few weeks that allows you to use WSMP
for ``internal evaluation or testing purposes'' (taken from the license agreement);
make sure you read the license agreement before downloading the library.
...
MA57, HSL\_MA86 or the Pardiso linear solver at runtime\footnote{This is not
...
The linear solvers MA57, HSL\_MA86, and MUMPS can make use of the matrix
...
MA57, HSL\_MA86, MUMPS, and the build system.
