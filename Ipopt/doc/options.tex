...
\paragraph{print\_frequency\_iter:}\label{sec:print_frequency_iter} Determines at which iteration frequency the summarizing iteration output line should be printed. $\;$ \\
...
\paragraph{print\_frequency\_time:}\label{sec:print_frequency_time} Determines at which time frequency the summarizing iteration output line should be printed. $\;$ \\
...
\paragraph{ma77\_print\_level:}\label{sec:ma77_print_level} Debug printing level for the linear solver MA77 $\;$ \\
 Meep The valid range for this integer option is
${\tt -inf} <  {\tt ma77\_print\_level } <  {\tt +inf}$
and its default value is $-1$.


\paragraph{ma77\_buffer\_lpage:}\label{sec:ma77_buffer_lpage} Number of scalars per MA77 buffer page $\;$ \\
...
\paragraph{ma77\_buffer\_npage:}\label{sec:ma77_buffer_npage} Number of pages that make up MA77 buffer $\;$ \\
...
\paragraph{ma77\_file\_size:}\label{sec:ma77_file_size} Target size of each temporary file for MA77, scalars per type $\;$ \\
...
\paragraph{ma77\_maxstore:}\label{sec:ma77_maxstore} Maximum storage size for MA77 in-core mode $\;$ \\
...
\paragraph{ma77\_nemin:}\label{sec:ma77_nemin} Node Amalgamation parameter $\;$ \\
...
\paragraph{ma77\_small:}\label{sec:ma77_small} Zero Pivot Threshold $\;$ \\
...
\paragraph{ma77\_static:}\label{sec:ma77_static} Static Pivoting Threshold $\;$ \\
...
\paragraph{ma77\_u:}\label{sec:ma77_u} Pivoting Threshold $\;$ \\
 See MA77 documentation. The valid range for this real option is 
$0 \le {\tt ma77\_u } \le 0.5$
and its default value is $1 \cdot 10^{-08}$.


\paragraph{ma77\_umax:}\label{sec:ma77_umax} Maximum Pivoting Threshold $\;$ \\
...
\paragraph{ma86\_order:}\label{sec:ma86_order} Controls type of ordering used by HSL\_MA86 $\;$ \\
 This option controls ordering for the solver
HSL\_MA86.
The default value for this string option is "amd".
\\ 
Possible values:
\begin{itemize}
...
\paragraph{ma86\_scaling:}\label{sec:ma86_scaling} Controls scaling of matrix $\;$ \\
...
\paragraph{ma97\_print\_level:}\label{sec:ma97_print_level} Debug printing level for the linear solver MA97 $\;$ \\
 <0 no printing.
0  Error and warning messages
only.
=1 Limited diagnostic printing.
>1
Additional diagnostic printing. The valid range for this integer option is
${\tt -inf} <  {\tt ma97\_print\_level } <  {\tt +inf}$
and its default value is $0$.


\paragraph{ma97\_nemin:}\label{sec:ma97_nemin} Node Amalgamation parameter $\;$ \\
 Two nodes in elimination tree are merged if
...
\paragraph{ma97\_order:}\label{sec:ma97_order} Controls type of ordering used by HSL\_MA97 $\;$ \\
 This option controls ordering for the solver
HSL\_MA97.
...
\paragraph{ma97\_scaling:}\label{sec:ma97_scaling} Specifies strategy for scaling in HSL\_MA97 linear solver $\;$ \\
 Specifies strategy for scaling in HSL\_MA97
linear solver
...
specifed by ma97\_scalingX and ma97\_switchX
options.
\end{itemize}

\paragraph{ma97\_scaling1:}\label{sec:ma97_scaling1} First scaling. $\;$ \\
 If ma97\_scaling=dynamic, this scaling is used
according to the trigger ma97\_switch1. If
ma97\_switch2 is triggered it is disabled.
The default value for this string option is "mc64".
\\ 
Possible values:
\begin{itemize}
...
\paragraph{ma97\_scaling2:}\label{sec:ma97_scaling2} Second scaling. $\;$ \\
 If ma97\_scaling=dynamic, this scaling is used
according to the trigger ma97\_switch2. If
ma97\_switch3 is triggered it is disabled.
The default value for this string option is "mc64".
\\ 
Possible values:
\begin{itemize}
...
\paragraph{ma97\_scaling3:}\label{sec:ma97_scaling3} Third scaling. $\;$ \\
 If ma97\_scaling=dynamic, this scaling is used
according to the trigger ma97\_switch3.
The default value for this string option is "mc64".
\\ 
Possible values:
\begin{itemize}
...
\paragraph{ma97\_small:}\label{sec:ma97_small} Zero Pivot Threshold $\;$ \\
...
\paragraph{ma97\_switch1:}\label{sec:ma97_switch1} First switch, determine when ma97\_scaling1 is enabled. $\;$ \\
...
ignored
The default value for this string option is "od\_hd\_reuse".
\\ 
Possible values:
\begin{itemize}
...
\paragraph{ma97\_switch2:}\label{sec:ma97_switch2} Second switch, determine when ma97\_scaling2 is enabled. $\;$ \\
...
\paragraph{ma97\_switch3:}\label{sec:ma97_switch3} Third switch, determine when ma97\_scaling3 is enabled. $\;$ \\
 If ma97\_scaling=dynamic, ma97\_scaling3 is
enabled according to this condition.
The default value for this string option is "never".
\\ 
Possible values:
\begin{itemize}
...
\paragraph{ma97\_u:}\label{sec:ma97_u} Pivoting Threshold $\;$ \\
 See MA97 documentation. The valid range for this real option is 
$0 \le {\tt ma97\_u } \le 0.5$
and its default value is $1 \cdot 10^{-08}$.


\paragraph{ma97\_umax:}\label{sec:ma97_umax} Maximum Pivoting Threshold $\;$ \\
 See MA97 documentation. The valid range for this real option is 
