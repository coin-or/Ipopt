...
typedef void (*pardisoinit_old_t)(
   void*         PT,
   const ipfint* MTYPE,
   ipfint*       IPARM
   );

typedef void (*pardiso_old_t)(
   void**        PT,
   const ipfint* MAXFCT,
   const ipfint* MNUM,
   const ipfint* MTYPE,
...
typedef void (*pardisoinit_new_t)(
   void*         PT,
   const ipfint* MTYPE,
   const ipfint* SOLVER,
   ipfint*       IPARM,
