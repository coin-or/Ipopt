...
// $Id$
//
// Authors:  Sanjeeb Dash, Andreas Waechter     IBM    2009-07-08

#ifndef __AMPLPARTNLP_HPP__
#define __AMPLPARTNLP_HPP__
...
namespace Ipopt
{
  ...
  /** wrapper which allows parallel processes to read and process ampl files*/
  class AmplParTNLP : public ParTNLP
  {
  public:

    /**@name Constructors/Destructors */
    //@{
    AmplParTNLP(SmartPtr<AmplTNLP> amplobj);
  ...
  private:
    ...
    /** Copy Constructor */
    AmplParTNLP(const AmplParTNLP&);

    /** Overloaded Equals Operator */
    void operator=(const AmplParTNLP&);
    //@}

    SmartPtr<AmplTNLP> amplobj_;
