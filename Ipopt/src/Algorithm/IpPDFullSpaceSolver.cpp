...
namespace Ipopt
{
    ...
    IteratesVector& resid)
  {
    ...
    // x
    //res.x()->Print(Jnlst(), J_WARNING, J_LINEAR_ALGEBRA, "res_x");
    //W.Print(Jnlst(), J_WARNING, J_LINEAR_ALGEBRA, "MyW");
    W.MultVector(1., *res.x(), 0., *resid.x_NonConst());
    //resid.x()->Print(Jnlst(), J_WARNING, J_LINEAR_ALGEBRA, "resid_x 1");
