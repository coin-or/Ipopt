...
namespace Ipopt
{
  ...
  IterativeSolverTerminationTester::IterativeSolverTerminationTester()
  {
    DBG_START_METH("IterativeSolverTerminationTester::IterativeSolverTerminationTester",dbg_verbosity);
  }
  ...
  void IterativeSolverTerminationTester::RegisterOptions(SmartPtr<RegisteredOptions> roptions)
  {
  ...
  bool IterativeSolverTerminationTester::InitializeImpl(const OptionsList& options,
  ...
  bool IterativeSolverTerminationTester::InitializeSolve()
  {
  ...
  void
  IterativeSolverTerminationTester::Clear()
  {
    DBG_START_METH("IterativeSolverTerminationTester::Clear",
                   dbg_verbosity);
