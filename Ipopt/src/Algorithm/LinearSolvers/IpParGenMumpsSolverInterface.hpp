...
//                  (based on IpParMumpsSolverInterface.hpp rev 1517)

#ifndef __IPPARGENMUMPSSOLVERINTERFACE_HPP__
#define __IPPARGENMUMPSSOLVERINTERFACE_HPP__
...
namespace Ipopt
{
  ...
  */
  class ParGenMumpsSolverInterface: public SparseSymLinearSolverInterface
  {
  public:
    /** @name Constructor/Destructor */
    //@{
    /** Constructor */
    ParGenMumpsSolverInterface();

    /** Destructor */
    virtual ~ParGenMumpsSolverInterface();
    //@}
    ...
    */
    ...
    {
      DBG_ASSERT(false && "This should not be called");
      return -1;
    }
    //@}
  ...
  private:
    ...
    * they will not be implicitly created/called. */
    //@{
    /** Copy Constructor */
    ParGenMumpsSolverInterface(const ParGenMumpsSolverInterface&);

    /** Overloaded Equals Operator */
    void operator=(const ParGenMumpsSolverInterface&);
    //@}
