...
//               (based on IpWsmpSolverInterface.hpp rev 1729)
//

#ifndef __IPPARCOLLECTWSMPSOLVERINTERFACE_HPP__
#define __IPPARCOLLECTWSMPSOLVERINTERFACE_HPP__
...
namespace Ipopt
{
   ...
   */
  class ParCollectWsmpSolverInterface: public SparseSymLinearSolverInterface
  {
  public:
    /** @name Constructor/Destructor */
    //@{
    /** Constructor */
    ParCollectWsmpSolverInterface();

    /** Destructor */
    virtual ~ParCollectWsmpSolverInterface();
    //@}
  ...
  private:
    ...
    //@{
    /** Copy Constructor */
    ParCollectWsmpSolverInterface(const ParCollectWsmpSolverInterface&);

    /** Overloaded Equals Operator */
    void operator=(const ParCollectWsmpSolverInterface&);
    //@}
